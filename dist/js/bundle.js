...
(function (global, factory) {
	 true ? module.exports = factory(__webpack_require__(7), __webpack_require__(4), __webpack_require__(9)) :
...
var Item = _backbone2.default.Model.extend({
    ...
    createCheckboxID: function createCheckboxID() {
        var id = +new Date();
        return id;
    }
});
...
var _LayoutView = __webpack_require__(10);
...
var _InputView = __webpack_require__(11);

var _InputView2 = _interopRequireDefault(_InputView);

var _ListView = __webpack_require__(13);
...
var InputView = _backbone2.default.View.extend({
    ...
    showChooseAll: function showChooseAll() {
    ...
    checkIsAllItemsCompleted: function checkIsAllItemsCompleted() {
        var count = 0;
...
with(obj||{}){
__p+='<input type="text" placeholder="What needs to be done?" id="main_input">\n<div class="choose_all" ';
 if(chooseAllShow) { 
__p+=' style=\'visibility: visible;\' ';
 } 
__p+='>\n    <input type="checkbox" id="choose_all" '+
((__t=( chooseAll ))==null?'':_.escape(__t))+
...
var Menu = _backbone4.default.View.extend({
